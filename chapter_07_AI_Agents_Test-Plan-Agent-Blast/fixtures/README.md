...
These are synthetic tickets, not real Jira data. Replace `BOOK-214` with a
captured real response once live credentials are available (Phase 2 fixture capture).